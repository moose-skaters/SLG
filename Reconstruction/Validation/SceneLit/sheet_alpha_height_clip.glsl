...
float u_xlat16_23;
float u_xlat16_24;
#define _SheetAnimationON 1.00000000
#define _MainTexSheet vec4(3.00000000,2.00000000,0.00000000,0.00000000)
#define _MainTexSheetAnimSpeed 1.00000000
#define _MainTex_ST vec4(0.80000000,0.70000000,0.05000000,0.10000000)
#define _AlphaIsR 1.00000000
#define _Color vec4(0.80000000,0.60000000,0.40000000,0.70000000)
#define _Intensity 0.90000000
#define _AlphFadeY_ON 1.00000000
#define _FadeY 0.15000000
#define _EMISSIONMAPON_ON 1.00000000
#define _EmissionIntensity 0.40000000
#define _EmissionColor vec4(0.20000000,0.30000000,0.40000000,1.00000000)
#define _EMISSIONMAPON_BUILDING_ON 0.60000000
#define _Timeline 0.25000000
#define _Time vec4(0.00000000,2.75000000,5.50000000,8.25000000)
void main(){
  ...
  (u_xlat16_23 = (u_xlat16_1.w + (-_CutOff)));
  (u_xlatb14 = (u_xlat16_23 < 0.0));
  if (u_xlatb14)
  {
    discard;
  }
