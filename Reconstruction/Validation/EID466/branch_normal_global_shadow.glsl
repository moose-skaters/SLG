...
#define _NormalMinHeight 400.0
#define _NormalMaxHeight 500.0
#define _BaseNormalScale 10.0
#define _MaxHeight 720.0
#define _BlurPlaneShadowOn 1
#define _BlurPlaneShadowColor vec4(0.05,0.02,0.01,0.5)
