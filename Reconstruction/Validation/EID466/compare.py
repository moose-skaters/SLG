...
pairs = {
    "captured_defaults": ("renderdoc_eid466.png", "unity_eid466.png"),
    "height_blend_and_edge": ("renderdoc_height_edge.png", "unity_height_edge.png"),
    "normal_global_and_shadow": ("renderdoc_normal_global_shadow.png", "unity_normal_global_shadow.png"),
}
results = {}
