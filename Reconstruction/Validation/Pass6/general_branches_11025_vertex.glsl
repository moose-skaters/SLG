...
void main(){
  ...
  (u_xlat7.xy = (u_xlat1.xy + (-in_TEXCOORD0.xy)));
  (vs_TEXCOORD2.zw = u_xlat1.xy);
  (u_xlat1.xy = ((vec2(vec2(_UVChannel, _UVChannel)) * u_xlat7.xy) + in_TEXCOORD0.xy));
  ...
  (u_xlat16_2.xy = ((in_TEXCOORD0.xy * _DissolveTex_ST.xy) + _DissolveTex_ST.zw));
  (u_xlat16_2.xy = (u_xlat16_2.xy + vec2(-0.5, -0.5)));
  (u_xlat16_2.xy = ((u_xlat16_2.xy * _dissolveUVMove.zz) + vec2(0.5, 0.5)));
  (u_xlat0.xy = (_Time.yy * _dissolveUVMove.xy));
  (u_xlat0.xy = fract(u_xlat0.xy));
  (vs_TEXCOORD2.xy = (u_xlat0.xy + u_xlat16_2.xy));
