...
void main(){
  ...
  (u_xlat16_7 = (u_xlat16_0.x + (-u_xlat16_1.x)));
  (u_xlat16_1.w = ((_Alpha_NO_R * u_xlat16_7) + u_xlat16_1.x));
  if ((_ParallaxOn != 0))
  {
    ...
    (u_xlat2.xy = (vec2(u_xlat18) * vs_TEXCOORD8.xy));
    ...
    (u_xlat16_9.xyz = (u_xlat16_2.xyz + (-_ParallaxEdgeColor.xyz)));
    (u_xlat16_1.xyz = ((u_xlat16_3.xxx * u_xlat16_9.xyz) + _ParallaxEdgeColor.xyz));
  }
  else
  {
  ...
  (u_xlat6 = (vs_TEXCOORD2.z + (-_Diss_value)));
  (u_xlat6 = ((_Particle_diss_ON * u_xlat6) + _Diss_value));
  ...
  (u_xlat16_3.xyz = (u_xlat2.xyz * u_xlat16_1.xyz));
  (u_xlat12.xy = ((vs_TEXCOORD1.xy * _Diss_Tex_ST.xy) + _Diss_Tex_ST.zw));
  (u_xlat12.xy = ((_Time.yy * vec2(_Diss_UV.x, _Diss_UV.y)) + u_xlat12.xy));
  (u_xlat16_12 = texture(_Diss_Tex, u_xlat12.xy).x);
  (u_xlat12.x = (u_xlat16_12 + 1.0));
  (u_xlat16_5.xy = ((-vec2(vec2(_Diss_Soft_value, _Diss_Soft_value))) + vec2(1.0, 2.0)));
  (u_xlat6 = (((-u_xlat6) * u_xlat16_5.y) + u_xlat12.x));
  (u_xlat16_21 = (u_xlat6 + _EdgeWidth));
  (u_xlat16_21 = (u_xlat16_21 + (-_Diss_Soft_value)));
  (u_xlat16_5.x = (1.0 / u_xlat16_5.x));
  (u_xlat16_21 = (u_xlat16_21 * u_xlat16_5.x));
  (u_xlat16_21 = clamp(u_xlat16_21, 0.0, 1.0));
  (u_xlat16_11 = ((u_xlat16_21 * -2.0) + 3.0));
  (u_xlat16_21 = (u_xlat16_21 * u_xlat16_21));
  (u_xlat16_17 = (u_xlat6 + (-_Diss_Soft_value)));
  (u_xlat16_5.x = (u_xlat16_5.x * u_xlat16_17));
  (u_xlat16_5.x = clamp(u_xlat16_5.x, 0.0, 1.0));
  (u_xlat16_17 = ((u_xlat16_5.x * -2.0) + 3.0));
  (u_xlat16_5.x = (u_xlat16_5.x * u_xlat16_5.x));
  (u_xlat16_5.x = (u_xlat16_5.x * u_xlat16_17));
  (u_xlat16_21 = ((u_xlat16_11 * u_xlat16_21) + (-u_xlat16_5.x)));
  (u_xlat16_1.xyz = (((-u_xlat16_1.xyz) * u_xlat2.xyz) + _Diss_Edge_color.xyz));
  (u_xlat16_1.xyz = ((vec3(u_xlat16_21) * u_xlat16_1.xyz) + u_xlat16_3.xyz));
  (u_xlat16_3.x = ((_Diss_Edge_NO * u_xlat16_21) + u_xlat16_5.x));
  (u_xlat16_6.xy = texture(_Mask, vs_TEXCOORD5.xy).xw);
  (u_xlat16_9.x = ((-u_xlat16_6.x) + u_xlat16_6.y));
  (u_xlat16_9.x = ((_Mask_A * u_xlat16_9.x) + u_xlat16_6.x));
  (u_xlat16_15 = ((u_xlat16_0.x * _Tex02_Color.x) + (-u_xlat2.w)));
  (u_xlat16_15 = ((_Tex2_A_NO_R * u_xlat16_15) + u_xlat2.w));
  (u_xlat16_19 = (u_xlat16_1.w * u_xlat16_3.x));
  (u_xlat16_19 = (u_xlat16_19 * _Main_Color.w));
  (u_xlat16_19 = (u_xlat16_19 * _Alpha));
  (u_xlat16_19 = (u_xlat16_9.x * u_xlat16_19));
  (u_xlat16_19 = (u_xlat16_19 * vs_COLOR0.w));
  (u_xlat0.x = (u_xlat16_15 * u_xlat16_19));
