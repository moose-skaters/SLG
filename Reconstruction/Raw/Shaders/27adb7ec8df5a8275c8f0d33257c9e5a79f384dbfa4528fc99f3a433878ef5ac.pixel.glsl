...
void main(){
  ...
  (u_xlat12.xyz = ((-u_xlat2.xxx) + _MainLightColor.xyz));
  (u_xlat2.xyz = ((vec3(_LightColorDesat) * u_xlat12.xyz) + u_xlat2.xxx));
  (u_xlat32 = _MainLightPosition.y);
  (u_xlat32 = clamp(u_xlat32, 0.0, 1.0));
  (u_xlat3.xyz = (u_xlat16_18.xyz * vec3(u_xlat32)));
  ...
  (u_xlat16_22 = texture(_SparkMap, vs_TEXCOORD6.zw, _GlobalMipBias.x).w);
  (u_xlat16_4.xy = texture(_SpecMaskMap, u_xlat2.xy, _GlobalMipBias.x).xy);
  (u_xlat16_8.xyz = (vec3(u_xlat16_22) * _SparkColor.xyz));
