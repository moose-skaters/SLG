...
layout(location = 1) uniform sampler2D _AlphaMap;
layout(location = 2) uniform sampler2D _Control;
layout(location = 3) uniform sampler2D _BaseNormal;
layout(location = 4) uniform sampler2D _NormalMask;
layout(location = 5) uniform sampler2D _Splat0;
layout(location = 6) uniform sampler2D _Splat1;
layout(location = 7) uniform sampler2D _Splat2;
layout(location = 8) uniform sampler2D _Splat3;
layout(location = 9) uniform sampler2D _Splat_Golobal;
layout(location = 10) uniform sampler2D _SparkMap;
layout(location = 11) uniform sampler2D _SpecMaskMap;
...
void main(){
  ...
  (u_xlat16_35 = texture(_AlphaMap, vs_TEXCOORD0.xy, _GlobalMipBias.x).x);
  ...
  (u_xlat2.x = (u_xlat16_35 * _AlphaScale));
