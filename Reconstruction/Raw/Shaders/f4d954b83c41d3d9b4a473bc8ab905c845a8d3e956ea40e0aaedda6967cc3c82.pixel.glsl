...
layout(location = 4) uniform sampler2D _Mask_Tex;
layout(location = 5) uniform sampler2D _Mask_Tex02;
...
void main(){
  ...
  (u_xlat22 = (vs_TEXCOORD1.z + (-_Diss_Tex_value)));
  (u_xlat22 = ((_Diss_Tex_Particle_ON * u_xlat22) + _Diss_Tex_value));
