...
layout(location = 1) uniform sampler2D _Diss_Tex;
layout(location = 2) uniform sampler2D _Mask;
...
void main(){
  ...
  (u_xlat16_6 = (u_xlat16_0.x + (-u_xlat16_1.x)));
  (u_xlat16_1.w = ((_Alpha_NO_R * u_xlat16_6) + u_xlat16_1.x));
  if ((_ParallaxOn != 0))
  {
    (u_xlat16_0.w = u_xlat16_1.w);
    (u_xlati2 = _ParallaxChannel);
    (u_xlat16_3.x = dot(u_xlat16_0, ImmCB_0[u_xlati2]));
    (u_xlat15 = ((-u_xlat16_3.x) + 1.0));
    (u_xlat2.xy = (vec2(u_xlat15) * vs_TEXCOORD8.xy));
    ...
    (u_xlat16_8.xyz = (u_xlat16_2.xyz + (-_ParallaxEdgeColor.xyz)));
    (u_xlat16_1.xyz = ((u_xlat16_3.xxx * u_xlat16_8.xyz) + _ParallaxEdgeColor.xyz));
  }
  else
  {
  ...
  (u_xlat0.x = (vs_TEXCOORD2.z + (-_Diss_value)));
  (u_xlat0.x = ((_Particle_diss_ON * u_xlat0.x) + _Diss_value));
  ...
  (u_xlat5.xyz = (u_xlat16_1.xyz + vec3(-0.5, -0.5, -0.5)));
  (u_xlat5.xyz = ((u_xlat5.xyz * vec3(vec3(_Contrast, _Contrast, _Contrast))) + vec3(0.5, 0.5, 0.5)));
  (u_xlat5.xyz = clamp(u_xlat5.xyz, 0.0, 1.0));
  (u_xlat16_1.xyz = (u_xlat5.xyz * _Main_Color.xyz));
  (u_xlat16_1.xyz = (u_xlat16_1.xyz * vec3(vec3(_Brightness, _Brightness, _Brightness))));
  (u_xlat16_3.xyz = (u_xlat16_1.xyz * vs_COLOR0.xyz));
  (u_xlat5.xy = ((vs_TEXCOORD1.xy * _Diss_Tex_ST.xy) + _Diss_Tex_ST.zw));
  (u_xlat5.xy = ((_Time.yy * vec2(_Diss_UV.x, _Diss_UV.y)) + u_xlat5.xy));
  (u_xlat16_5 = texture(_Diss_Tex, u_xlat5.xy).x);
  (u_xlat5.x = (u_xlat16_5 + 1.0));
  (u_xlat16_4.xy = ((-vec2(vec2(_Diss_Soft_value, _Diss_Soft_value))) + vec2(1.0, 2.0)));
  (u_xlat0.x = (((-u_xlat0.x) * u_xlat16_4.y) + u_xlat5.x));
  (u_xlat16_18 = (u_xlat0.x + _EdgeWidth));
  (u_xlat16_18 = (u_xlat16_18 + (-_Diss_Soft_value)));
  (u_xlat16_4.x = (1.0 / u_xlat16_4.x));
  (u_xlat16_18 = (u_xlat16_18 * u_xlat16_4.x));
  (u_xlat16_18 = clamp(u_xlat16_18, 0.0, 1.0));
  (u_xlat16_9 = ((u_xlat16_18 * -2.0) + 3.0));
  (u_xlat16_18 = (u_xlat16_18 * u_xlat16_18));
  (u_xlat16_14 = (u_xlat0.x + (-_Diss_Soft_value)));
  (u_xlat16_4.x = (u_xlat16_4.x * u_xlat16_14));
  (u_xlat16_4.x = clamp(u_xlat16_4.x, 0.0, 1.0));
  (u_xlat16_14 = ((u_xlat16_4.x * -2.0) + 3.0));
  (u_xlat16_4.x = (u_xlat16_4.x * u_xlat16_4.x));
  (u_xlat16_4.x = (u_xlat16_4.x * u_xlat16_14));
  (u_xlat16_18 = ((u_xlat16_9 * u_xlat16_18) + (-u_xlat16_4.x)));
  (u_xlat16_1.xyz = (((-u_xlat16_1.xyz) * vs_COLOR0.xyz) + _Diss_Edge_color.xyz));
  (u_xlat16_1.xyz = ((vec3(u_xlat16_18) * u_xlat16_1.xyz) + u_xlat16_3.xyz));
  (u_xlat16_3.x = ((_Diss_Edge_NO * u_xlat16_18) + u_xlat16_4.x));
  (u_xlat16_0.xy = texture(_Mask, vs_TEXCOORD5.xy).xw);
  (u_xlat16_8.x = ((-u_xlat16_0.x) + u_xlat16_0.y));
  (u_xlat16_8.x = ((_Mask_A * u_xlat16_8.x) + u_xlat16_0.x));
  (u_xlat16_16 = (u_xlat16_1.w * u_xlat16_3.x));
  (u_xlat16_16 = (u_xlat16_16 * _Main_Color.w));
  (u_xlat16_16 = (u_xlat16_16 * _Alpha));
  (u_xlat16_16 = (u_xlat16_8.x * u_xlat16_16));
  (u_xlat0.x = (u_xlat16_16 * vs_COLOR0.w));
