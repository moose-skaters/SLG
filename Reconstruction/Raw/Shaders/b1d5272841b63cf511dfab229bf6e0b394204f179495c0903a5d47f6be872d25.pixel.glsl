...
layout(location = 1) uniform sampler2D _Tex_2;
...
void main(){
  ...
  (u_xlat16_0 = texture(_Tex_2, vs_TEXCOORD5.zw));
  (u_xlat2 = (u_xlat16_0 * _Tex02_Color));
  ...
  (u_xlat4.xyz = (u_xlat16_1.xyz + vec3(-0.5, -0.5, -0.5)));
  (u_xlat4.xyz = ((u_xlat4.xyz * vec3(vec3(_Contrast, _Contrast, _Contrast))) + vec3(0.5, 0.5, 0.5)));
  (u_xlat4.xyz = clamp(u_xlat4.xyz, 0.0, 1.0));
  (u_xlat16_1.xyz = (u_xlat4.xyz * _Main_Color.xyz));
  ...
  (u_xlat16_3.x = ((u_xlat16_0.x * _Tex02_Color.x) + (-u_xlat2.w)));
  (u_xlat16_3.x = ((_Tex2_A_NO_R * u_xlat16_3.x) + u_xlat2.w));
  (u_xlat16_13 = (u_xlat16_1.w * _Main_Color.w));
  (u_xlat16_13 = (u_xlat16_13 * _Alpha));
  (u_xlat16_13 = (u_xlat16_13 * vs_COLOR0.w));
  (u_xlat0.x = (u_xlat16_3.x * u_xlat16_13));
