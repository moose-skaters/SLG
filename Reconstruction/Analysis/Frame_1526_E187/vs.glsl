...
void main(){
  ...
  (u_xlat5.xyz = (u_xlat3.wxy * u_xlat4.yzx));
  (u_xlat4.xyz = ((u_xlat3.ywx * u_xlat4.zxy) + (-u_xlat5.xyz)));
  (u_xlatb24 = (unity_WorldTransformParams.w >= 0.0));
  (u_xlat24 = ((u_xlatb24) ? (1.0) : (-1.0)));
  (u_xlat16_6.x = (u_xlat24 * in_TANGENT0.w));
  (vs_TEXCOORD4.xyz = (u_xlat4.xyz * u_xlat16_6.xxx));
